...
#define BOOT_CONFIG_PROGRAMMABLE_ADDRESS_LOW 0x0
#define BOOT_CONFIG_PROGRAMMABLE_ADDRESS_HIGH 0x0
...
#define BOOT_CONFIG_USER_IVT_TABLE_ADDRESS 0x0


#define BOOT_CONFIG_VERSION 0x0102

#define BOOT_CONFIG_MAX_PACKET_SIZE 0x0
